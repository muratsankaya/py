...
def main():
    ...
    layers = [
        SigmoidActivation(),
        # FullyConnected(n_hidden_nodes, n_hidden_nodes, regularizer=reg),
        # SigmoidActivation(),
        FullyConnected(n_hidden_nodes, 1, regularizer=reg),
        SigmoidActivation()
    ]

    # layers = [
    #     FullyConnected(2, n_hidden_nodes, regularizer=reg),
    #     SigmoidActivation(),
    #     FullyConnected(n_hidden_nodes, n_hidden_nodes, regularizer=reg),
    #     SigmoidActivation(),
    #     FullyConnected(n_hidden_nodes, 1, regularizer=reg),
