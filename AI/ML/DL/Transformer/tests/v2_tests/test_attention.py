...
notes:
    - Since these test are adopted from version 1 its 
    designed as if the pad_token_id would be 0
"""

import torch
import torch.nn.functional as F
from tests.helper_functions import print_green
from src.transformer_v2 import attention, get_attention_mask
from tests.v2_tests.helper_functions import get_pad_mask
